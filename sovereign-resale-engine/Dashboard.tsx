...
export default function SovereignDashboardV5_1() {
  ...
  useEffect(() => {
    const discoverPort = async () => {
      const scanRange = [3010, 3011, 3012, 3013, 3014, 3015];
          ...
          <div style={{ padding: '3rem 3rem 1.5rem', background: 'rgba(255,255,255,0.02)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
             <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2.5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                        <h2 style={{ margin: 0, fontSize: '1.4rem', fontWeight: 900, letterSpacing: -1 }}>ASIF <span style={{ color: ACCENT }}>DIGITAL</span></h2>
                        <div style={{ fontSize: '0.65rem', opacity: 0.4, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1 }}>Sovereign Engine v5</div>
                    </div>
                </div>
      ...
      {(windowWidth >= 1024 || isSidebarOpen) && (
        <aside style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: '1.5rem', padding: '0 0.5rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 900, fontSize: '1.3rem', letterSpacing: '-0.05em', color: TEXT_PRIMARY, lineHeight: 1 }}>ASIF <span style={{ color: ACCENT }}>DIGITAL</span></div>
              <div style={{ fontSize: '0.6rem', color: TEXT_SECONDARY, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1.5, marginTop: 4 }}>Sovereign Engine v5</div>
            </div>
          </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td style={{ padding: '2rem 1rem' }}>
                                        ...
                                        <div style={{ fontSize: '0.75rem', color: TEXT_SECONDARY, marginTop: 4, fontWeight: 600 }}>{p.type.replace('_', ' ').toUpperCase()}</div>
                                        {p.contact_name && (
