      ...
      <aside style={{ width: 320, borderRight: '1px solid rgba(255,255,255,0.03)', padding: '2.5rem 2rem', display: 'flex', flexDirection: 'column', gap: '2.5rem', background: 'rgba(0,0,0,0.4)', position: 'sticky', top: 0, height: '100vh' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.6rem', opacity: 0.5, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1.5 }}>ELITE RESALE EDITION</div>
          </div>
        </div>
        ...
        <div style={{ marginTop: 'auto' }}>
            <GlassCard style={{ padding: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.03)' }}>
                ...
                <div style={{ fontSize: '0.85rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 8, color: ACCENT }}>
                    ...
                    {config.COMPANY_NAME || config.company_name || 'Asif Digital Agency'}
                </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {discoveryLeads.length === 0 && (
                            <tr>
                                <td colSpan={6} style={{ padding: '4rem', textAlign: 'center', opacity: 0.2 }}>No pending targets found. Launch a new search above.</td>
                            </tr>
                        )}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td style={{ padding: '1.8rem 1rem' }}>
                                        ...
                                        <div style={{ fontSize: '0.65rem', opacity: 0.3, marginTop: 4 }}>{p?.type?.replace('_', ' ').toUpperCase() || 'AUTO'}</div>
                                        {p.contact_name && (
                                ...
                                <td style={{ padding: '1.8rem 1rem' }}>
                                    ...
                                    {p.mobile_number && (
                                        <div style={{ marginTop: 8 }}>
                                            <a href={`https://wa.me/${p?.mobile_number?.toString()?.replace('+', '')}`} target="_blank" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(37, 211, 102, 0.15)', color: '#25D366', padding: '4px 8px', borderRadius: 6, textDecoration: 'none', fontSize: '0.7rem', fontWeight: 800, border: '1px solid rgba(37, 211, 102, 0.3)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
             ...
             <GlassCard style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ padding: '15px', background: 'rgba(29, 158, 117, 0.05)', borderRadius: 12, border: '1px solid rgba(29, 158, 117, 0.1)', fontSize: '0.8rem', color: ACCENT }}>
                    ...
                    <div style={{ marginTop: 10, fontFamily: 'monospace', fontSize: '0.7rem', opacity: 0.6 }}>
                        [INFO] Resale Engine v5.1 Active<br/>
                        [DB] Using: sovereign_resale_v5.db<br/>
                        [IDENTITY] {config.COMPANY_NAME || config.company_name || 'Asif Digital Agency'}
                    </div>
                </div>
             </GlassCard>
          </div>
             ...
             <GlassCard style={{ padding: 0, overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {sentLeads.length === 0 && (
                            <tr>
                                <td colSpan={5} style={{ padding: '4rem', textAlign: 'center', opacity: 0.2 }}>No emails sent yet. Select targets in Discovery Engine to start.</td>
                            </tr>
                        )}
                        {sentLeads.map(p => (
