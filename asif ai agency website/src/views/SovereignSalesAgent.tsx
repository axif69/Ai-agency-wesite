      ...
      <section className="min-h-[85vh] flex flex-col items-center justify-center relative overflow-hidden px-6 md:px-12 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/contact" className="bg-white text-black px-10 py-5 rounded-full font-bold uppercase tracking-widest text-[10px] hover:bg-white/80 transition-all shadow-[0_0_40px_rgba(255,255,255,0.15)]">Initiate Operational Audit</Link>
            <Link href="/ai-marketing-agency-dubai" className="border border-white/20 text-white px-10 py-5 rounded-full font-bold uppercase tracking-widest text-[10px] hover:bg-white/10 transition-all">Sovereign Marketing Strategy</Link>
          </div>
        </motion.div>
      </section>
      ...
      <section className="py-40 px-6 md:px-12 text-center relative overflow-hidden border-t border-white/5">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-8">
            <Link href="/contact" className="bg-white text-black px-12 py-6 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-white/80 transition-all shadow-[0_0_60px_rgba(255,255,255,0.1)]">Speak with Khalid (Strategic Intake Agent)</Link>
