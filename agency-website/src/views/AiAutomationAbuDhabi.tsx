...
export default function AiAutomationAbuDhabi() {
  ...
  return (
    <div ref={containerRef} className="bg-[#050505] min-h-screen text-white pt-24 selection:bg-white/30">
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center relative overflow-hidden px-6 md:px-12 text-center">
        ...
        <motion.div style={{ opacity, scale }} className="max-w-6xl relative z-10">
          ...
          <h1 className="text-5xl md:text-9xl font-serif tracking-tighter leading-[0.85] mb-12">
            ...
            <span className="text-white/60 italic font-light tracking-normal">Agency in Abu Dhabi.</span>
          </h1>
          ...
          <div className="space-y-12 text-white/70 font-light text-lg leading-relaxed">
            ...
            <div className="p-8 border border-white/10 bg-white/[0.02] rounded-3xl mt-12 border-l-4 border-l-white/20">
              ...
              <p className="text-sm text-white/50 italic">
                A typical mid-level office employee in Abu Dhabi costs upwards of AED 35,000/month. An autonomous cognitive agent, once deployed, costs pennies per thousand tokens while operating at 100x the speed. This is the arbitrage we install.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
            {[
              ...
              { icon: <HardDrive className="w-6 h-6" />, title: "On-Prem / Sovereign Cloud", desc: "Deployment on GCC-based infrastructure (Oracle Cloud Abu Dhabi / Azure UAE North) to ensure zero data egress and absolute privacy." },
      ...
      {/* Chapter 3: Industry Specifics (Abu Dhabi Focus) (600 Words) */}
      <section className="py-32 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="p-12 border border-white/5 bg-white/[0.01] rounded-[3rem] hover:bg-white/[0.02] transition-all group">
             ...
             <p className="text-white/50 font-light leading-relaxed mb-10">
               Abu Dhabi is the world's logistics hub. Our AI agents automate manifest analysis, predictive warehouse routing, and real-time response to Red Sea or global transit delays.
             </p>
             <div className="space-y-4 text-sm text-white/30 italic">
               <p>“Automated 4,000+ monthly manifests for a KIZAD-based distributor, reducing processing time by 92%.”</p>
             </div>
           </div>
           ...
           <div className="p-12 border border-white/5 bg-white/[0.01] rounded-[3rem] hover:bg-white/[0.02] transition-all group">
             ...
             <p className="text-white/50 font-light leading-relaxed mb-10">
               Operating in ADGM or ADGM requires rigorous compliance. Our AI systems automate KYC/AML checks, legal document summarization, and regulatory gap analysis.
             </p>
             <div className="space-y-4 text-sm text-white/30 italic">
           ...
           <div className="p-12 border border-white/5 bg-white/[0.01] rounded-[3rem] hover:bg-white/[0.02] transition-all group">
             ...
             <p className="text-white/50 font-light leading-relaxed mb-10">
               From predictive maintenance in Abu Dhabi's oil fields to automated QC in Abu Dhabi Industrial City, we bridge the gap between heavy hardware and agentic software.
             </p>
             <div className="space-y-4 text-sm text-white/30 italic">
           ...
           <div className="p-12 border border-white/5 bg-white/[0.01] rounded-[3rem] hover:bg-white/[0.02] transition-all group">
             ...
             <p className="text-white/50 font-light leading-relaxed mb-10">
               Aligned with the Abu Dhabi Digital Strategy. We develop private, secure AI assistants that improve citizen experience and internal civil service efficiency.
             </p>
             <div className="space-y-4 text-sm text-white/30 italic">
