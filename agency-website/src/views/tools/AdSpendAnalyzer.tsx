...
export default function AdSpendAnalyzer() {
  ...
  return <ToolPageFrame eyebrow="Free Ad Spend Analyzer" title="Ad Spend Analyzer: Calculate CPL, CPA, ROAS & Wasted Ad Budget" description="Enter your real campaign and sales numbers or upload a CSV to calculate CPL, CPA, ROAS and break-even thresholds, then identify tracking and funnel gaps. No ad-account login required."
