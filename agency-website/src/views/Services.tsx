...
const categories = [
  ...
  },
  {
    ...
    services: [
      { title: "Enterprise Web Architecture", desc: "Premium, conversion-focused digital domains crafted for elite UAE brands. Every pixel is a calculated move toward market dominance.", features: ["Bespoke UI/UX", "GSAP Animations", "Core Web Vitals", "AEO-Ready"], link: "/services/web-design-dubai", icon: <Monitor className="w-8 h-8" /> },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              {cat.services.map((service, i) => (
                ...
                >
                  ...
                  <Link href={service.link} className="inline-flex items-center justify-between w-full py-5 border-t border-white/10 uppercase tracking-[0.2em] text-[10px] font-bold hover:text-[#0066FF] transition-all group-hover:border-[#0066FF]/20">
      ...
      <section className="px-6 md:px-12 py-32 bg-white/[0.02] border-y border-white/5 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="/contact" className="bg-white text-black px-12 py-5 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-[#0066FF] hover:text-white transition-all duration-500 shadow-2xl">
