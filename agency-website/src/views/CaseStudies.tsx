  ...
  return (
    <div className="px-6 md:px-12 py-20 max-w-7xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-36 p-14 border border-white/5 rounded-2xl text-center bg-white/[0.02]">
        ...
        <Link href="/contact" className="bg-white text-black px-10 py-4 rounded-full font-bold uppercase tracking-widest text-xs hover:bg-white/80 transition-colors inline-flex items-center gap-2">Book your free AI consultation with Asif Digital <ArrowRight className="w-4 h-4" /></Link>
      </motion.div>
    </div>
  );
}
