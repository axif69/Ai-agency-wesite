...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    "/real-estate",
    "/real-estate/whatsapp-ai-automation",
    "/real-estate/ai-lead-dashboard",
    ...
    "/services",
    "/tools",
    "/tools/ai-website-grader",
    "/tools/ai-marketing-strategy-generator",
    "/tools/ad-spend-efficiency-analyzer",
