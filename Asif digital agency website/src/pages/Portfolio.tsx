...
const portfolioItems = [
  { id: 1, title: "Zenith Properties — Luxury Real Estate Website", category: "Web Design", location: "Dubai, UAE", desc: "A premium real estate website for a Dubai luxury developer featuring immersive property galleries, bilingual Arabic/English toggle, lead capture flows, and full Local SEO optimization. Ranked #1 on Google in 11 weeks.", img: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format,compress&fm=webp&q=75&w=1200", link: "#" },
  { id: 2, title: "TechGadgets UAE — Headless Ecommerce Platform", category: "Ecommerce", location: "Sharjah, UAE", desc: "2,400-SKU headless ecommerce store built on Next.js + Shopify with Telr payment gateway, product schema for every listing, and an AI-powered recommendation engine. Revenue increased 340% in 6 months.", img: "https://images.unsplash.com/photo-1557821552-17105176677c?auto=format,compress&fm=webp&q=75&w=1200", link: "#" },
  ...
  { id: 4, title: "AutoElite Sharjah — Google Ads Overhaul", category: "PPC", location: "Sharjah, UAE", desc: "Complete Google Ads account rebuild with 1,200 negative keywords, 6 custom landing pages, and smart bidding. Cost-per-lead reduced from AED 420 to AED 67 in 60 days.", img: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format,compress&fm=webp&q=75&w=1200", link: "#" },
  { id: 5, title: "Aurum Café — Brand Identity & Social Media", category: "Branding", location: "Sharjah, UAE", desc: "Complete brand identity from scratch—logo, typography, colour palette, packaging—plus a 12-month social media strategy that grew Instagram from 800 to 28,000 followers and 5x Saturday revenue.", img: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format,compress&fm=webp&q=75&w=1200", link: "#" },
  ...
  { id: 11, title: "Atlas Investment Group — Brand Identity", category: "Branding", location: "Dubai, UAE", desc: "Premium brand identity for a Dubai private equity firm. Logo mark, 72-page brand guidelines, pitch deck template, and bilingual English/Arabic stationery suite. Completed in 4 weeks.", img: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format,compress&fm=webp&q=75&w=1200", link: "#" },
